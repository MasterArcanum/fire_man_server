...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/fav.png"}],"style":[],"script":[],"noscript":[],"title":"Памятник пожарным-спасателям"};
